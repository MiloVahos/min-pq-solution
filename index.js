...
/*
  CONSIDERATIONS WHEN WE HAVE A BIG SOURCES COUNT (1M FOR EXAMPLE)
  
  The solution will have a memory problem because it initializes the Min Priority Queue with the first log entry from each log source.
  This is the main bottleneck of the solution, because it will store all the log entries in memory before starting to print them.
